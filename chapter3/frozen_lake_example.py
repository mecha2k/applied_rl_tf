...
def update_q_matrix(prior_state, observation, reward, action):
    ...
    Q_matrix[prior_state, action] = Q_matrix[prior_state, action] + learning_rate * (
...
def populate_q_matrix(render=False, n_episodes=n_episodes):
    ...
    for episode in range(n_episodes):
        ...
        while _ < max_steps:
            ...
            update_q_matrix(
                prior_state=prior_state, observation=observation, reward=reward, action=action
            )
    ...
    for episode in range(n_episodes):
        ...
        while not done:
            ...
            if reward == 0:
                ...
                print(f"You have won on episode {episode+1}!")
                time.sleep(5)
                os.system("clear")
